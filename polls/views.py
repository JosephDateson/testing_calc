...
htmlHeaderTextWithDate = htmlIndexFile.HTML_HEADER_TEXT.replace("#date#", time.strftime("%H:%M %d/%m/%y"))
...
def create_html_table(dimensions_matrix,dimensions_rows_categories_names,dimensions_columns_categories_names):
    ...
    html_string += htmlIndexFile.HTML_END_TEXT.replace("<csv_content_placeholder>",create_csv())
