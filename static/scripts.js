...
/*load and save files*/
var load_data = {
    'Settlements':{var_name_1:'',var_val_1:'',strategies_vector_single:'1,2,3,4,5,(1,2),(1,3),(1,4),(1,5),(2,3),(2,4),(2,5),(3,4),(3,5),(4,5)',strategies_vector_length:'',strategies_full_set:'',strategies_lower_bound:'',strategies_upper_bound:'',strategies_constraint_1:'',payment_if_res_1:'0',payment_if_cond_1:'exists(i,j,si=rj)',payment_if_res_2:'5',payment_if_cond_2:'AND(NOT(exists(i,j,si=rj)),exists(i,si=5))',payment_if_res_3:'4',payment_if_cond_3:'AND(NOT(exists(i,j,si=rj)),exists(i,si=4))',payment_if_res_4:'3',payment_if_cond_4:'AND(NOT(exists(i,j,si=rj)),exists(i,si=3))',payment_if_res_5:'2',payment_if_cond_5:'AND(NOT(exists(i,j,si=rj)),exists(i,si=2))',payment_if_res_6:'1',payment_if_cond_6:'AND(NOT(exists(i,j,si=rj)),exists(i,si=1))',dimensions_row_category_name_1:'avoid',dimensions_row_if_cond_1:'countcells(1)+countcells(2)=0',dimensions_row_category_name_2:'not avoid',dimensions_row_if_cond_2:'else',dimensions_column_category_name_1:'one',dimensions_column_if_cond_1:'else',dimensions_column_category_name_2:'two',dimensions_column_if_cond_2:'len(s)>1',},	'Blotto_loc':{var_name_1:'',var_val_1:'',strategies_vector_single:'',strategies_vector_length:'3',strategies_full_set:'0,1,2,3,4,5,6,7',strategies_lower_bound:'',strategies_upper_bound:'',strategies_constraint_1:'SUM(s)=7',payment_if_res_1:'0.5',payment_if_cond_1:'percell(i,si=ri)',payment_if_res_2:'1',payment_if_cond_2:'percell(i,si>ri)',dimensions_row_category_name_1:'L',dimensions_row_if_cond_1:'foreach(i,si<=s1)',dimensions_row_category_name_2:'S',dimensions_row_if_cond_2:'foreach(i,si>=s1)',dimensions_row_category_name_3:'M',dimensions_row_if_cond_3:'else',dimensions_column_category_name_1:'1',dimensions_column_if_cond_1:'countcells(0)=2',dimensions_column_category_name_2:'2',dimensions_column_if_cond_2:'countcells(0)=1',dimensions_column_category_name_3:'3',dimensions_column_if_cond_3:'else',},
	'Blotto_loc':{var_name_1:'',var_val_1:'',strategies_vector_single:'',strategies_vector_length:'3',strategies_full_set:'0,1,2,3,4,5,6,7',strategies_lower_bound:'',strategies_upper_bound:'',strategies_constraint_1:'SUM(s)=7',payment_if_res_1:'0.5',payment_if_cond_1:'percell(i,si=ri)',payment_if_res_2:'1',payment_if_cond_2:'percell(i,si>ri)',dimensions_row_category_name_1:'L',dimensions_row_if_cond_1:'foreach(i,si<=s1)',dimensions_row_category_name_2:'S',dimensions_row_if_cond_2:'foreach(i,si>=s1)',dimensions_row_category_name_3:'M',dimensions_row_if_cond_3:'else',dimensions_column_category_name_1:'1',dimensions_column_if_cond_1:'countcells(0)=2',dimensions_column_category_name_2:'2',dimensions_column_if_cond_2:'countcells(0)=1',dimensions_column_category_name_3:'3',dimensions_column_if_cond_3:'else',},
	'Blotto_center':{var_name_1:'',var_val_1:'',strategies_vector_single:'',strategies_vector_length:'3',strategies_full_set:'0,1,2,3,4,5,6',strategies_lower_bound:'',strategies_upper_bound:'',strategies_constraint_1:'SUM(s)=6',payment_if_res_1:'0.5',payment_if_cond_1:'percell(i,si=ri)',payment_if_res_2:'1',payment_if_cond_2:'percell(i,si>ri)',dimensions_row_category_name_1:'decreasing',dimensions_row_if_cond_1:'decreasing()',dimensions_row_category_name_2:'increasing',dimensions_row_if_cond_2:'increasing()',dimensions_row_category_name_3:'other',dimensions_row_if_cond_3:'else',dimensions_column_category_name_1:'1',dimensions_column_if_cond_1:'countcells(0)+countcells(1)=2',dimensions_column_category_name_2:'2',dimensions_column_if_cond_2:'countcells(0)+countcells(1)=1',dimensions_column_category_name_3:'3',dimensions_column_if_cond_3:'else',},
	'Tennis':{var_name_1:'',var_val_1:'',strategies_vector_single:'',strategies_vector_length:'3',strategies_full_set:'0,1,2',strategies_lower_bound:'',strategies_upper_bound:'',strategies_constraint_1:'',payment_if_res_1:'1',payment_if_cond_1:'percell(i,si>ri)',payment_if_res_2:'0.5',payment_if_cond_2:'percell(i,si=ri)',payment_if_res_3:'percellcost(i,-si*0.33)',payment_if_cond_3:'TRUE',dimensions_row_category_name_1:'Strong',dimensions_row_if_cond_1:'MAX(s)=cell(s1)',dimensions_row_category_name_2:'not Strong',dimensions_row_if_cond_2:'else',dimensions_column_category_name_1:'0',dimensions_column_if_cond_1:'SUM(s)=0',dimensions_column_category_name_2:'1',dimensions_column_if_cond_2:'SUM(s)=1',dimensions_column_category_name_3:'2',dimensions_column_if_cond_3:'SUM(s)=2',dimensions_column_category_name_4:'3',dimensions_column_if_cond_4:'SUM(s)=3',dimensions_column_category_name_5:'4',dimensions_column_if_cond_5:'SUM(s)=4',dimensions_column_category_name_6:'5',dimensions_column_if_cond_6:'SUM(s)=5',dimensions_column_category_name_7:'6',dimensions_column_if_cond_7:'SUM(s)=6'},
	'All_pay':{var_name_1:'T',var_val_1:'4',var_name_2:'M',var_val_2:'12',strategies_vector_single:'',strategies_vector_length:'3',strategies_full_set:'',strategies_lower_bound:'0',strategies_upper_bound:'T',strategies_constraint_1:'ignore permutations',strategies_constraint_2:'exclude=(0,0,0)',payment_if_res_1:'M',payment_if_cond_1:'count(i,si>ri) + 0.5*count(i,si=ri) >=2',payment_if_res_2:'0',payment_if_cond_2:'count(i,si>ri) + 0.5*count(i,si=ri) <2',payment_if_res_3:'percellcost(i,-si)',payment_if_cond_3:'TRUE',dimensions_row_category_name_1:'1',dimensions_row_if_cond_1:'countcells(0)=2',dimensions_row_category_name_2:'2',dimensions_row_if_cond_2:'countcells(0)=1',dimensions_row_category_name_3:'3',dimensions_row_if_cond_3:'else',dimensions_column_category_name_1:'H',dimensions_column_if_cond_1:'countcells(i,si>=T/2+1)=countcells(i,si>0)',dimensions_column_category_name_2:'mix',dimensions_column_if_cond_2:'else',dimensions_column_category_name_3:'L',dimensions_column_if_cond_3:'countcells(i,si<=T/2)=countcells(i,si>0)',},
	};
...
function add_loaded_field(full_field_name) {
	...
	switch (String(field_name))
	{
	   ...
	   case "var_name_": add_field('variables_definition',brackets_name=''); break;
	   case "var_val_": break;
	   default: break;
	}
}
...
function load_example(example_name)
{
	...
	change_collapse_def(has_var_name_1);
	load(jsonData);
}
